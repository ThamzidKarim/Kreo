...
function Home() {
    return (
        <div className="min-h-screen bg-white">
            ...
            <Link to="/new-project" className="relative w-[90%] max-w-[924px] h-[250px] bg-[#EBE7E7] rounded-[46px] left-[100px] hover:bg-[#adadad] transition-colors cursor-pointer shadow-lg">
